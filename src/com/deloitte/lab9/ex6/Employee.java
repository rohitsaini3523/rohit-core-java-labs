...
public class Employee {
    ...
    public Employee(int employeeId, String firstName, String lastName, String email, String phoneNumber,
            LocalDate hireData, String designation, double salary, int managerId, Department department) {
    ...
    public String toString() {
        return "Employee [employeeId=" + employeeId + ", firstName=" + firstName + ", lastName=" + lastName + ", email="
                + email + ", phoneNumber=" + phoneNumber + ", hireData=" + hireData + ", designation=" + designation
